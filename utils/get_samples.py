...
from .stylegan2 import load_seq_stylegan
from . import zdataset, proggan
...
paths = {
    ...
    'kitchen': '/home/gridsan/ahnobari/rashad/lsun/lsun_kitchen_val/',
    'places':
    ...
    'bike':'/home/gridsan/ahnobari/rashad/bike/',
    'oldbike':'/home/gridsan/ahnobari/rashad/bike/',
    'polygon4':'/home/gridsan/ahnobari/rashad/polygon_dataset4/'
}
...
def load_model(model, name, truncated):
    if model == 'stylegan':
        ...
        g = proggan.load_pretrained(name).cuda()
    else:
